""" 
    ...
    Author: Tanner Maine
    Date: 24 July 2022
    Description: WhatABook finished program
"""
...
def show_books(_cursor):
    ...
    # for selection in books give details 
    for book in books:
...
def show_account_menu():
    """ display the specific users account menu """
...
def show_wishlist(_cursor, _user_id):
    """ searching database for books in users wishlist """
...
try:
    """ try block for handling SQL errors """ 
    ...
    while user_selection != 4:
        ...
        # if the user selects option 1, call the show_books function and display the books
        if user_selection == 1:
            show_books(cursor)

        # if the user selects option 2, call the show_locations function and display the locations
        if user_selection == 2:
            show_locations(cursor)

        # if the user selects option 3, call the validate_user function to validate the inputted user_id 
        ...
        if user_selection == 3:
            ...
            while account_option != 3:
                ...
                # if the user selects option 1, call the show_wishlist() function to show the current users 
